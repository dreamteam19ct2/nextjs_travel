                    ...
                    <div className={styles.content}>
                        <div className={styles.fill}>
                            <div className={styles.fill_line}>
                                ...
                                <div className={styles.fill_line_right}><input type="text" onChange={handleInputChange} name="tourName" value={tourName} /></div>
                            </div>

                            <div className={styles.fill_line}>
                                <div className={styles.fill_line_left}>Tour description : </div>
                                <div className={styles.fill_line_right}><input type="text" onChange={handleInputChange} name="description" value={description} /></div>
                            </div>

                            <div className={styles.fill_line}>
                                <div className={styles.fill_line_left}>Number of people :</div>
                                <div className={styles.fill_line_right}><input type="text" onChange={handleInputChange} name="maxPeople" value={maxPeople} /></div>
                            </div>

                            <div className={styles.fill_line}>
                                <div className={styles.fill_line_left}>Price/person: </div>
                                <div className={styles.fill_line_right}><input type="text" onChange={handleInputChange} name="price" value={price} /></div>
                            </div>

                            <div className={styles.fill_line}>
                                <div className={styles.fill_line_left}>Day Start :</div>
                                <div className={styles.fill_line_right}><input type="text" onChange={handleInputChange} name="dateStart" value={dateStart} /></div>
                            </div>

                            <div className={styles.fill_line}>
                                <div className={styles.fill_line_left}>Day End :</div>
                                <div className={styles.fill_line_right}><input type="text" onChange={handleInputChange} name="dateEnd" value={dateEnd} /></div>
                            </div>
                        </div>
                        ...
                        <div className={styles.frame_img}>
                            ...
                            <div className={styles.img_block}>
                                <input name="img" type="text" onChange={handleInputChange} className={styles.img_text} value={img} />
                        ...
                        <div className={styles.button_create}>
                            <div className={styles.position_img}>
                                <button type="submit" className={styles.btn_create}>Update</button>
                            </div>
                            <div className={styles.position_img}>
